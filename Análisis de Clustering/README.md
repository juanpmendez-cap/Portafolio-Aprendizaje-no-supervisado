...
Además del análisis cuantitativo de los clusters, se realizaron visualizaciones y comparaciones entre modelos para interpretar la separación entre grupos y evaluar la calidad de las particiones obtenidas.

Durante el desarrollo se utilizaron bibliotecas de Python orientadas a ciencia de datos y aprendizaje automático, incluyendo **pandas**, **NumPy**, **matplotlib**, **scikit-learn** y **SciPy**.
