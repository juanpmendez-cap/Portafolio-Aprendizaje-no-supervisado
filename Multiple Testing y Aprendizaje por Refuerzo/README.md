...
La segunda parte aborda conceptos de **Aprendizaje por Refuerzo (Reinforcement Learning)** mediante la interacción de un agente con entornos simulados. Se analizaron mecanismos de recompensa, exploración y toma de decisiones, además del comportamiento del agente durante el entrenamiento y evaluación en distintos episodios.

Durante el desarrollo se utilizaron bibliotecas de Python orientadas a ciencia de datos, análisis estadístico y aprendizaje automático, incluyendo **pandas**, **NumPy**, **matplotlib**, **scikit-learn**, **statsmodels** y **gymnasium**.

## Documentos incluidos

- [Reporte en formato ipynb](./Multiple%20Testing%20y%20Aprendizaje%20por%20Refuerzo.ipynb)
- [Reporte en formato html](./Multiple%20Testing%20y%20Aprendizaje%20por%20Refuerzo.html)
